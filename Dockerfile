# Multi-stage build for beneficiaries service
...
# Run the application
ENTRYPOINT ["sh", "-c", "java $JAVA_OPTS -cp .:./lib/* com.alok.payment.beneficiaries.BeneficiariesApplication"]
