...
public class ValidationSteps {
    ...
    public void createBeneficiaryWithAccountNumber(String accountNumber) {
        BeneficiaryRequest request = createBasicRequest();
        request.setCustomerId("CUST_VAL_" + generateUniqueId());
        request.setBeneficiaryAccountNumber(accountNumber);
        performRequest(request);
    }
    ...
    public void createBeneficiaryWithBankCode(String bankCode) {
        BeneficiaryRequest request = createBasicRequest();
        request.setCustomerId("CUST_VAL_" + generateUniqueId());
        request.setBeneficiaryAccountNumber(generateValidAccountNumber());
        request.setBeneficiaryBankCode(bankCode);
        performRequest(request);
    }
    ...
    private BeneficiaryRequest createBasicRequest() {
        ...
        request.setCustomerId("CUST_VAL_" + uniqueId);
        request.setAccountNumber("ACC_VAL_" + uniqueId);
    ...
    /**
     * Generates a valid account number (8-20 digits).
     */
    private String generateValidAccountNumber() {
        return "1" + String.valueOf(System.currentTimeMillis()).substring(3, 10);
    }
